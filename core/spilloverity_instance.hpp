...
namespace instance {
	...
	protected:
		spilloverity(const innate::layer& layer);
...
namespace instance {
	...
	public:
		spilloverity_host(const ptree& root, const innate::layer& layer);
	...
	public:
		spilloverity_device(const ptree& root, const innate::layer& layer);
